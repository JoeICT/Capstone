    ...
    <div class="flex-container">
      ...
      <div id="res3"><h2><strong><span>What to look for in a contractor</span></strong></h2>
        <p>
          ...
          <br><br>
          You may also have access to reviews of the specific contractor or company. Be aware that all perfect reviews may be a great thing, it could also indicate that the ones leaving the review are not actual customers. Another thing to keep in mind is the time frame that the contractor says they can complete the job. If you get several estimates and one of them says that they will get the job done in a substantially shorter time than all the others that could be a red flag and indicate that they either dont know the actual time that the job will take or that they are just hoping to get the job knowing that it will take longer than they say it will.
          <br><br>
